...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/20 disabled:pointer-events-none disabled:opacity-50 active:scale-98 cursor-pointer select-none",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-indigo-500 to-teal-500 text-white shadow-lg shadow-indigo-500/20 hover:opacity-95",
        destructive:
          "bg-rose-600 text-white hover:bg-rose-700 shadow-lg shadow-rose-600/20",
        outline:
          "border border-slate-800 bg-slate-950 text-slate-200 hover:bg-slate-900 hover:text-white",
